...
$data['2'] = empty($data['2']) ? null : 'Предполагаемое место установки в схеме флотационного обогащения: ' . is_null($data['otherPlace']) ? $data['2'] : $data['otherPlace'];
$data['3'] = empty($data['3']) ? null : 'Требуется ли насос для перекачивания пульпы с производительностью, превышающей перерабатываемый объем пульпы в 3 раза и обеспечивающий давление не ниже 0,2 МПа: ' . $data['3'];
$data['4'] = empty($data['4']) ? null : 'Требуется ли сжатый воздух с давлением не менее 0,05 МПа в пятикратном объеме от объема перерабатываемой пульпы: ' . $data['4'];
