...
$data['message'] = empty($data['message']) ? null : 'Сообщение: <b>' . $data['message'] . '</b>';
...
$data['otherRawTitle'] = empty($data['otherRawTitle']) ? null : $data['otherRawTitle'];

if (isset($data['otherRawTitle'], $_REQUEST['otherRaw'])) $data['rawData'][$data['otherRawTitle']] = $_REQUEST['otherRaw'];
