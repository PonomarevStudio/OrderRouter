...
$dataItems = ['',
    'Выберите гранулометрический состав материала подвергаемого флотационному обогащению',
    'Кислотность пульпы, рН',
    'Соотношение Т:Ж в пульпе',
    'Объем пульпы, м3/час',
    'Химический, минералогический и фазовый состав руды'];
...
$data['otherPlace'] = empty($data['otherPlace']) ? null : 'Другое место установки: ' . $data['otherPlace'];
